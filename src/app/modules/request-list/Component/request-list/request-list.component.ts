  ...
  reqsTypes = []
    ...
    filtration = {
      ...Filtration,
       ...
       SortBy: 'Desc',
       RequestStatus: [[UserRequestsStatus.Pending, UserRequestsStatus.TentativelyAccepted ] , [UserRequestsStatus.TentativelyAccepted,UserRequestsStatus.Pending], UserRequestsStatus.ModificationRequest],
       RequestType:null,
