...
import { AssessmentService } from 'src/app/modules/dashboard/assessment/service/assessment.service';
...
export class EditNewSubjectComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   { this.headerService.Header.next(
      {
        'breadCrump': [
          { label: this.translate.instant('dashboard.Subjects.List Of Subjects'), routerLink: '/educational-settings/subject/subjects-list' ,routerLinkActiveOptions:{exact: true}},
         {
            ...
            routerLink: (this.urlParameter==null||this.urlParameter=='')? '/educational-settings/subject/new-subject':'/educational-settings/subject/edit-subject/'+this.urlParameter
          }
     ],
