    ...
    },
    {
      ...
      content:{
        ...
        list: [
          ...
          {label:this.translate.instant('breadcrumb.NotificationsSettings'), icon:'assets/images/home/system-manager-tools/fix.svg',url:'/dashboard/performance-managment/notifications/',claims:[ClaimsEnum.S_MenuItem_Setting]},
...

    {
      ...
      content:{
        ...
        list: [
          ...
          {label: this.translate.instant('sideBar.reportsManagment.chidren.attendanceReport'), icon:'assets/images/home/report-managment/report-edge.svg', url:'/dashboard/reports-managment/attendance-reports',claims:[ClaimsEnum.S_MenuItem_AbsenceReport]},
          ...
          {label:this.translate.instant('sideBar.reportsManagment.chidren.gradesReport'), icon:'assets/images/home/report-managment/report-content.svg', url:'/dashboard/reports-managment/degrees-reports',claims:[ClaimsEnum.S_MenuItem_DegreesReport]},
          {label:this.translate.instant('sideBar.reportsManagment.chidren.subjectsReport'), icon:'assets/images/home/report-managment/list.svg', url:'/dashboard/reports-managment/subjects-reports', claims:[ClaimsEnum.S_MenuItem_SubjectReport]},
          {label:this.translate.instant('sideBar.reportsManagment.chidren.EmployeesReport'), icon:'assets/images/home/report-managment/report-user.svg', url:'/dashboard/reports-managment/users-reports',claims:[ClaimsEnum.S_MenuItem_SchoolEmployeeReport]},
          {label:this.translate.instant('sideBar.reportsManagment.chidren.TeachersReport'), icon:'assets/images/home/report-managment/report-line.svg', url:'/dashboard/reports-managment/teachers-reports',claims:[ClaimsEnum.S_MenuItem_SchoolTeacherReport]},
        ]
      }
    },

    {
      ...
      content:{
        ...
        list: [
          ...
          {label:this.translate.instant('sideBar.educationalSettings.children.Subjects Assessments'), icon:'assets/images/home/educational-setting/note-marked.svg',url:'/dashboard/educational-settings/assessments/assements-list',claims:[ClaimsEnum.SE_MenuItem_Rate]},
        ]
      }
    ...
    },
    {
      ...
      content:{
        ...
        list: [
          ...
          {label:this.translate.instant('dashboard.schools.editableList'), icon:'assets/images/home/performance-managment/note-list.svg',url:`/dashboard/school-management/school/${currentSchoolId}/edit-list`, claims:[ClaimsEnum.SE_MenuItem_EditList]},
