...
export class SchoolSubjectsComponent implements OnInit {
  ...
  componentHeaderData: IHeader = {
		breadCrump: [
			...
			{ label: this.translate.instant('dashboard.schools.schoolSubjectMangement'), routerLink: `/school-management/school/${this.schoolId}/subjects`},
		],
  ...
  onExport(fileType: FileTypeEnum){
    let filter = {...this.filtration,PageSize:this.subjectsObj.totalAllData,Page:1}
