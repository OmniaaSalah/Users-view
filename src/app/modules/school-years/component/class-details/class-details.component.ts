   ...
   this.subjectService.getAllSPEASubjects().subscribe((res)=>{this.subjectList=res;})
    ...
    this.route.paramMap.subscribe(param => {
      ...
      else if(this.schoolYearUrlParameter&&this.classUrlParameter)
      {
        ...
        this.urlTittle='/educational-settings/school-year/display-school-year/'+this.schoolYearUrlParameter+'/curriculum/'+this.curriculumUrlParameter+'/class-details/'+this.classUrlParameter
      }
      else if(!this.schoolYearUrlParameter&&this.classUrlParameter)
      {
        this.subTittle='breadcrumb.class details';
        this.urlTittle='/educational-settings/school-year/new-school-year/curriculum/'+this.curriculumUrlParameter+'/class-details/'+this.classUrlParameter
      }
  ...
  this.schoolYearService.getSchoolYearByID(Number(this.schoolYearUrlParameter)).subscribe((res)=>{
    ...
    this.headerService.Header.next(
      ...
      {'breadCrump':[
        ...
        routerLink: (this.schoolYearUrlParameter==null||this.schoolYearUrlParameter.toString()=='')? '/educational-settings/school-year/new-school-year':'/educational-settings/school-year/display-school-year/'+this.schoolYearUrlParameter
