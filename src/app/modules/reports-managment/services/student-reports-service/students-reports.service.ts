...
import { ProhabitionType, StudentStatus, StatusEnum } from 'src/app/shared/enums/status/status.enum';
...
export class StudentsReportsService {
  ...
  constructor(
    ...
    this.studentsStatus = [
      {
        value:StudentStatus.Registered,
    ...
    this.prohibitionTypeList = [
      {
        ...
        name: this.translate.instant("students.ForbiddenFromCertificatefromAuthority")
      },
      {
        value:ProhabitionType.CertificateFromSchool,
        name:this.translate.instant("students.ForbiddenFromCertificatefromSchool")
      },
      {
        value: ProhabitionType.WithdrawingFromSPEA,
        name: this.translate.instant("students.ForbiddenFromWithdrowfromAuthority")
      },
      {
        value: ProhabitionType.WithdrawingFromSchool,
        name: this.translate.instant("students.ForbiddenFromWithdrowfromSchool")
      }
    ];
    this.registrationStatus=[
      {
        value:StudentStatus.NewRegistered,
        name:this.translate.instant("shared.allStatus.NewRegistered")
      },
      {
        value: StudentStatus.WithdrawalWithinTheEmirate,
        name: this.translate.instant("shared.allStatus.WithdrawalWithinTheEmirate")
      },
      {
        value: StudentStatus.WithdrawalOutsideTheEmirate,
        name: this.translate.instant("shared.allStatus.WithdrawalOutsideTheEmirate")
      },
      {
        value: StudentStatus.WithdrawalOutOfTheCountry,
