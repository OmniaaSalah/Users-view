...
export class UserRolesService {
  ...
  constructor() {
    ...
    this.userRolesListApi = [
      {id:0, 'roleUsers': 2, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مدرس', 'status': 'فعال', 'userName': 'محمد علي' },
      ...
      { id:2,'roleUsers': 3, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مهندس كمبيوتر', 'status': 'فعال', 'userName': 'محمد علي' },
      { id:3,'roleUsers': 4, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مساعد مدير', 'status': 'فعال', 'userName': 'محمد علي' },
      { id:4,'roleUsers': 0, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مدرس', 'status': 'غير فعال', 'userName':'محمد علي'},
      {id:5, 'roleUsers': 0, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مساعد مدير', 'status': 'غير فعال', 'userName': 'محمد علي' },
      { id:6,'roleUsers': 0, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مدرس', 'status': 'غير فعال', 'userName': 'محمد علي' },
      { id:7,'roleUsers': 0, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مدرس', 'status': 'غير فعال', 'userName':'محمد علي' },
      ...
      {id:9, 'roleUsers': 10, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مهندس كمبيوتر', 'status': 'فعال', 'userName': 'محمد علي'},
      ...
      { id:11,'roleUsers': 12, 'description': 'مهمة هذا الدور الرئيسية هي في مساعدة مدير النظام في ادارة النظام بشكل كامل واعطائه معظم الصلاحيات التي تساعده في الادارة', 'rolePowers': ['الصلاحية1','الصلاحية2','الصلاحية3'], 'dataRestrictionLevel': 'إمكانية وصول المستخدم إلى كافة معلومات المدارس', 'createdDate': '24/01/2022', 'jobRoleName': 'مهندس كمبيوتر', 'status': 'فعال', 'userName':'محمد علي' },
