...
export class AnnualHolidayComponent implements OnInit,OnDestroy{
  ...
  subscription:Subscription;
	holidaysItems: MenuItem[]=[
		{label: this.translate.instant('shared.edit'), icon:'assets/images/dropdown/pen.svg',routerLink:"/educational-settings/annual-holiday/edit-holiday/{{e.id}}"},
  ...
  gotoAddHoliday() {
    this.router.navigate(['/educational-settings/annual-holiday/new-holiday']);
  }
