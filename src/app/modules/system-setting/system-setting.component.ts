...
export class SystemSettingComponent implements OnInit {
  ...
  dashboardHeaderData ={'breadCrump':[{ label: this.translate.instant('sideBar.managerTools.children.systemSettings'),routerLink: '/manager-tools/settings',routerLinkActiveOptions:{exact: true} }]}
