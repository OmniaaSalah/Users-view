...
export class SystemSettingComponent implements OnInit {
  ...
  constructor(private headerService:HeaderService,
    ...
    private schoolYearServise:SchoolYearsService,
  ...
  ngOnInit(): void {
    ...
    this.headerService.Header.next(
      ...
      {'breadCrump':[
        { label: this.translate.instant('sideBar.managerTools.children.systemSettings'),routerLink: '/dashboard/manager-tools/systemSetting/System-Setting',routerLinkActiveOptions:{exact: true} }
